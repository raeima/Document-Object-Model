...
function roomOneAdd() {
  r1++; //Adds plus 1 to the number of people in room 1//
    if (r1 <= 3) {
      ...
      document.getElementById('oneAddButt').style.display = "none";
    }
}
function roomOneRemove() {
  ...
  document.getElementById('oneAddButt').style.display = "block";
}
...
function roomTwoAdd() {
  r2++; //Adds plus 1 to the number of people in room 2//
    if (r2 <= 3) {
      ...
      document.getElementById('twoAddButt').style.display = "none";
    }
}
function roomTwoRemove() {
  ...
  list.removeChild(list.childNodes[select]);
  document.getElementById('twoAddButt').style.display = "block";
}
...
function roomThreeAdd() {
  r3++; //Adds plus 1 to the number of people in room 3//
    if (r3 <= 3) {
      ...
      document.getElementById('threeAddButt').style.display = "none";
    }
}
function roomThreeRemove() {
  ...
  list.removeChild(list.childNodes[select]);
  document.getElementById('threeAddButt').style.display = "block";
}
...
function roomFourAdd() {
  r4++; //Adds plus 1 to the number of people in room 4//
    if (r4 <= 3) {
      ...
      document.getElementById('fourAddButt').style.display = "none";
    }
}
function roomFourRemove() {
  ...
  list.removeChild(list.childNodes[select])
  document.getElementById('fourAddButt').style.display = "block";
}
...
function roomFiveAdd() {
  r5++; //Adds plus 1 to the number of people in room 5//
    if (r5 <= 3) {
      ...
      document.getElementById('fiveAddButt').style.display = "none";
    }
}
function roomFiveRemove() {
  ...
  list.removeChild(list.childNodes[select]);
  document.getElementById('fiveAddButt').style.display = "block";
}
